  ...
  switch (node.name) {
    ...
    default:
      if (node === calleeNode && options && options.additionalHooks) {
        try {
          var name$23 = analyzePropertyChain(node, null);
        } catch (error) {
          if (/Unsupported node type/.test(error.message)) return 0;
          throw error;
        }
        return options.additionalHooks.test(name$23) ? 0 : -1;
      }
      return -1;
  }
}
...
var _require = require("../package.json"),
            ...
            if (!(0 < staleAssignments.size))
              if (declaredDependenciesNode) {
                ...
                var missingDependencies =
                  ...
                  suggestedDeps = _collectRecommendatio2.suggestedDependencies;
                if (
                  0 ===
                  ...
                  scanForConstructions({
                    ...
                    var wrapperHook =
                      ...
                      constructionType =
                        "function" === _ref4 ? "definition" : "initialization",
                      defaultAdvice =
                        "wrap the " +
                        constructionType +
                        " of '" +
                    ...
                    defaultAdvice =
                      ...
                      _ref4 +
                      " " +
                      ("conditional" === _ref4 || "logical expression" === _ref4
                        ? "could make"
                        : "makes") +
                      " the dependencies of " +
                      (reactiveHookName +
                    ...
                    missingDependencies.forEach(function (missingDep) {
                      if (!missingCallbackDep) {
                        ...
                        if (
                          ...
                          for (
                            var id, i$14 = 0;
                            i$14 < usedDep.references.length;
                            i$14++
                          )
                            if (
                              ((id = usedDep.references[i$14].identifier),
                              null != id &&
                                null != id.parent &&
                      ...
                      if (null === setStateRecommendation)
                        for (
                          var references =
                            ...
                            maybeCall,
                            i$15 = 0;
                          i$15 < references.length;
                          i$15++
                        ) {
                          id = references[i$15].identifier;
                          for (
                            maybeCall = id.parent;
                            null != maybeCall &&
  ...
  legacyRecommendedConfig = { plugins: ["react-hooks"], rules: configRules },
  reactHooksPlugin = {
...
assign({}, reactHooksPlugin, { configs: configs });
